/* game.js — overworld engine: 6 zones, town, coast, dungeon, river, enemies, elites, camera, loot, minimap, portals, NPCs */
const World = (() => {
  ...
  function buildGround(Z) {
    ...
    if (currentZone === 'town' || currentZone === 'coast' || currentZone === 'dungeon') {
      // town/coast/dungeon ground detail handled by their own builders
